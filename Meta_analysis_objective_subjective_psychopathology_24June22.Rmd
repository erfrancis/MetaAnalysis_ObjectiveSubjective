...
forest(maltreat_z,
       ...
       ilab.xpos=c(-1.55, -1.1), cex=0.25, 
       ilab.pos = c(4, 4),
       top=1.5) 
par(font=2)
text(c(-1.42, -0.92, 1.32), 43, c("Reference", "Maltreatment type", "Correlation [95% CI]"), cex=0.25)
```
...
forest(neighbour_data$r_obj_subj[neighbour_data$es_type=="correlation"],
       ...
       xlim=c(-1.5, 1.3), at=c(-0.2,0,0.2,0.4,0.6), 
       xlab = "Correlation", 
       mlab="Multivariate Meta-Analysis Model", 
       ...
       ilab.xpos= c(-1.55, -1.1, -0.9), cex=0.4, 
       ilab.pos = c(4, 4, 4),
       top=2) 
par(font=2)
text(c(-1.37,-0.63, 1.05), 3.2, c("Reference", "Neighbourhood type", "Correlation [95% CI]"), cex=0.45)
```
...
plot<-forest(subj_neighbour2,
       ...
       top=2) 
par(font=2)
text(c(-1.8, -1.17, -0.7, 1.05), 3.3, c("Reference", "Neighbourhood type", "Outcome", "Correlation [95% CI]"), cex=0.4)
